...
const challenges = [
  {
    title:       "Sum of a List",
    description: "Write a Python function that takes a list of numbers and returns their sum WITHOUT using the built-in sum() function.",
    language:    "python",
    difficulty:  "Easy",
    xpReward:    75,
...
`,
  ...
  },
  {
    ...
    description: "Write a Python function that reverses a string without using slicing [::-1] or the reversed() function.",
    language:    "python",
    difficulty:  "Easy",
    xpReward:    75,
...
`,
  ...
  {
    title:       "Count Vowels",
    description: "Write a Python function that counts the number of vowels (a, e, i, o, u) in a string. It should be case-insensitive.",
    language:    "python",
    difficulty:  "Easy",
    xpReward:    75,
...
`,
  ...
  },
  {
    ...
    description: "Write a Python function that finds the maximum value in a list WITHOUT using the built-in max() function.",
    language:    "python",
    difficulty:  "Easy",
    xpReward:    75,
...
`,
  ...
  {
    title:       "Is Palindrome",
    description: "Write a Python function that checks if a string is a palindrome (reads the same forwards and backwards). Ignore spaces and case.",
    language:    "python",
    difficulty:  "Medium",
    xpReward:    100,
...
`,
  ...
  },
  {
    ...
    description: "Write a Python function that returns the first n numbers of the Fibonacci sequence as a list.",
    language:    "python",
    difficulty:  "Medium",
    xpReward:    100,
