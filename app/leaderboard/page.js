      ...
      <div className="max-w-3xl mx-auto px-4 pt-28 pb-16">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400">
            Top learners ranked by XP and lesson completions.
          </p>
        </div>
            ...
            {entries.map((entry, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {rankCfg ? <RankIcon className="w-4 h-4" /> : rank}
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                      <p
                        className={`font-semibold truncate ${isMe ? "text-blue-400" : "text-white"}`}
                      >
                      ...
                      <span
                        className={`text-xs px-1.5 py-0.5 rounded bg-white/5 ${levelColor(entry.level ?? 1)}`}
                      >
