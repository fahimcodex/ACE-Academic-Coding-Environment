...
export const ALL_BADGES = [
  ...
  // Course completion
  {
    ...
    emoji: "🐍",
    name: "Pythonista",
    desc: "Complete the Python track",
    tier: "silver",
  },
  {
    id: "linux_done",
  ...
  },
  {
    ...
    emoji: "🏆",
    name: "All-Rounder",
    desc: "Complete all four language tracks",
    tier: "platinum",
  },
  ...
  // CodeQuest missions
  {
    ...
    emoji: "⚔️",
    name: "Quest Starter",
    desc: "Complete your first CodeQuest mission",
    tier: "bronze",
  },
  {
    id: "mission_10",
    emoji: "🗡️",
    name: "Story Coder",
    desc: "Complete 10 CodeQuest missions",
    tier: "silver",
  },
  {
    id: "mission_all_python",
    emoji: "🐍",
    name: "Pythonic Hero",
    desc: "Complete all Python CodeQuest missions",
    tier: "gold",
  },
  {
    id: "mission_all_c",
    emoji: "⚙️",
    name: "C Warrior",
    desc: "Complete all C CodeQuest missions",
    tier: "gold",
  },
  {
    id: "mission_all_cpp",
...
export function checkNewBadges(profile) {
  ...
  // Mission badges
  const missions = profile.missionsCompleted ?? 0;
  const pythonMissions = profile.pythonMissionsCompleted ?? 0;
  const cMissions = profile.cMissionsCompleted ?? 0;
  const cppMissions = profile.cppMissionsCompleted ?? 0;

  if (missions >= 1) check("mission_first");
  if (missions >= 10) check("mission_10");
  if (pythonMissions >= 30) check("mission_all_python");
  if (cMissions >= 10) check("mission_all_c");
  if (cppMissions >= 25) check("mission_all_cpp");
